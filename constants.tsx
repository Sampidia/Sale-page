...
export const EBOOKS: Ebook[] = [
  {
    ...
    detailedFeatures: [
      ...
      {
        title: 'Just $1 Digital Download',
        desc: 'Instant access for parents, teachers, and children at just one dollar.',
        icon: '💳'
      }
    ],
  ...
  },
  {
    ...
    price: 0,
    currency: 'NGN',
    cover3DUrl: 'assets/green_nanotechnology_3d_cover.png',
    coverFlatUrl: 'assets/green_nanotechnology_3d_cover.png',
    ogImage: 'assets/green_nanotechnology_3d_cover.png',
    badge: 'Coming Soon',
    isFree: true,
    comingSoon: true,
    pagesCount: 82,
  ...
  },
  {
    ...
    price: 0,
    currency: 'NGN',
    cover3DUrl: 'assets/corrosion_rate_welded_metals_3d_cover.png',
    coverFlatUrl: 'assets/corrosion_rate_welded_metals_3d_cover.png',
    ogImage: 'assets/corrosion_rate_welded_metals_3d_cover.png',
    badge: 'M.Sc. Research',
    isFree: true,
    pagesCount: 74,
    hasPortraitPdf: true,
    ...
    features: [
      ...
      'Gravimetric weight-loss measurements over controlled exposure periods',
      'Corrosion rate comparison: mild steel, galvanised, stainless steel & zinc',
      'Practical implications for material selection in industrial welding'
    ],
    sampleExcerpt: 'Accelerated galvanic corrosion occurs in welded samples of dissimilar metals due to electrochemical potential differences at the weld interface...'
  }
];
