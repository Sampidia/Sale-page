  ...
  async fetch(request, env, ctx) {
    ...
    if (request.method === 'POST' && url.pathname === '/api/verify') {
      try {
        ...
        // Query unused passcodes for this tournament from the "passcodes" table
        ...
        // Find the first code value that is NOT already purchased in DB purchases table
        let passcode = null;
        ...
        // 6. Mark passcode as used in env.NAW_DB (passcodes table)
        try {
